...
func (g *Generator) generateClient(clientFile string, clientPkg string, funcs template.FuncMap) (err error) {
	...
	for packagePath := range im {
		if packagePath != "github.com/keitaroinc/goa" {
	...
	imports := []*codegen.ImportSpec{
		...
		codegen.SimpleImport("github.com/keitaroinc/goa"),
		codegen.NewImport("goaclient", "github.com/keitaroinc/goa/client"),
		codegen.NewImport("uuid", "github.com/keitaroinc/goa/uuid"),
	}
